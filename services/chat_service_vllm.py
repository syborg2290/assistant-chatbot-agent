...
# # Set Hugging Face cache path from .env
# os.environ["TRANSFORMERS_CACHE"] = os.getenv("HF_CACHE_DIR", "./models/cache")
...
#     download_dir="./models/llama-3.1-8b",
# )
...
#     feedback = (
#         state["human_feedback"][-1] if state["human_feedback"] else "No feedback yet"
#     )
...
#         assistant_specific_prompt += (
#             f"- Support phone number(s): {filtered_values['support_phone_numbers']}\n"
#         )
...
#     Avoid:
#     - Meta-comments like “This response is helpful because…” or “Here’s a message that…”
...
#     **Reminder**:
#     You're not writing about a response — you’re just responding. Be the assistant the user would want to talk to: helpful, human, and straight to the point.
#     """
...
# graph.add_edge("retrieve_node", "model")
...
# def start_conversation_service_vllm(
#     client_ip: str,
#     message: str,
#     company_id: str,
#     user_id: str,
...
# def chat_service_vllm(thread_id: str, message: str):
#     try:
...
# def feedback_service_vllm(thread_id: str, feedback: str):
#     try:
#         if thread_id not in session_store:
#             raise ValueError("Invalid thread_id")

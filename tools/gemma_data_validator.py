...
class GemmaContentValidator:
    """
    Comprehensive content validation system using Gemma via Ollama.
    Features:
...
#     validator = GemmaContentValidator(risk_threshold="medium")
...
#         "The weather is lovely, let's go for a walk.",
#         "This book is fantastic! I highly recommend it.",
#         "Our company meeting is at 3 PM. Please join on time.",
#         # Harmful content examples
#         # 1. Illegal activities (drugs, weapons, trafficking)
#         "Selling unlicensed firearms, contact me at 123-456-7890.",
#         "Need some cocaine? DM me for prices.",
#         # 2. Hate speech/discrimination
#         "We should eliminate all members of [ethnic group].",
#         "Those people are ruining our country.",
#         # 3. Sexual content/exploitation
#         "Explicit adult content message with illegal activities.",
#         "Offering illegal adult services, contact for details.",
#         # 4. Personal information (PII)
#         "Meet me at 123-456-7890 with the package.",
#         "My social security number is 123-45-6789.",
#         """AWS Configuration:
#             AWS_ACCESS_KEY_ID=AKIAEXAMPLEKEY123
#             AWS_SECRET_ACCESS_KEY=EXAMPLE/SECRET/KEY/123456""",
#         """Database Credentials:
#             postgres://user:password123@localhost/db""",
#         """Stripe Payment Setup:
#             stripe_token = sk_test_1234567890abcdefghijklmnop
#             """,
#         # 5. Violence/terrorism/extremism
#         "We must attack the building at dawn to make a statement.",
#         "Join our group to plan the next assault.",
#         # 6. Copyright violations
#         "Here's the cracked version of the software. Download now!",
#         "Sharing movies for free: [pirate link].",
#         # 7. Toxic/harassment content
#         "You're such a worthless piece of trash, nobody likes you.",
#         "Just end your life, nobody cares about you.",
#     ]

#     # Running test cases
#     for text in test_cases:
#         validation_result = gemma_data_validator.validate_text(text)

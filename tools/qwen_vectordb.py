...
class QwenVectorDB:
    """Handles AI-powered querying using Qwen and a vector database."""
    ...
    def _initialize_qa_chain(self):
        """Creates an AI assistant using Qwen and LangChain with current parameters."""
        template = """ <start>

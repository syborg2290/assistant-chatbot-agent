...
class DeepSeekContentValidator:
    """
    Comprehensive content validation system using DeepSeek-R1 via Ollama.
    Features:
...
#     validator = DeepSeekContentValidator(risk_threshold="medium")
